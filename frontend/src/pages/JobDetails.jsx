        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-6 sm:p-8 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-1">Job Type</p>
                <p className="text-gray-900 dark:text-white font-semibold capitalize">{job.type}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-1">Posted On</p>
                <p className="text-gray-900 dark:text-white font-semibold">{formattedDate}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-1">Salary</p>
